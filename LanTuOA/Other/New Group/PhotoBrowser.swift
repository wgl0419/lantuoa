...
//  SexyColor.Swift
//
//  Created by ________ on 2017/9/7.
//  Copyright © 2017年 ________. All rights reserved.
//
...
class PhotoBrowser: UIView {
    ...
    func setSubViews() {
        ...
        pageControl = UIPageControl(frame: CGRect(x: 0, y: ScreenHeight - 30 - SafeH, width: 5, height: 30))
...
extension PhotoBrowser : UICollectionViewDelegate, UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return max(images.count, imageViews.count)
    }

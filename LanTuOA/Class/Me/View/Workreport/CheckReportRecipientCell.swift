//
//  CheckReportRecipientCell.swift
//  LanTuOA
//
...
class CheckReportRecipientCell: UITableViewCell {
    /// 添加回调
    var addBlock: (() -> ())?
    /// 点击删除回调
    var deleteBlock: ((Int) -> ())?
...
extension CheckReportRecipientCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
